...
== Requirement
  ...
  * Ruby 1.9.x, Ruby 2.0.x

== Install

  $ [sudo] gem install rbtree-ng

Or grab the sourcecode from https://github.com/Quintus/rbtree:

  $ git clone git://github.com/Quintus/rbtree

and then

  $ rake compile
  $ rake gem
  $ [sudo] gem install pkg/rbtree-ng-*.gem
...
== Links
  ...
  * {GitHub page}[https://github.com/Quintus/rbtree]
